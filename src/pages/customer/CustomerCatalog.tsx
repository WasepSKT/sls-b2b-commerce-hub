              ...
              {products.map((product) => (
                <Card key={product.id} className={cn(
                  ...
                  <div className="relative aspect-[4/3]">
                    <img
                      ...
                      className={cn(
                        ...
                        !product.images[0] && "hover:opacity-75"
                      )}
                      onError={(e) => {
                    ...
                    {product.discount > 0 && (
                      <div className="absolute top-2 right-2">
                        <span
                          className="px-2.5 py-1 text-xs rounded-full font-medium shadow-sm bg-red-500 text-white"
                        >
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      <div>
                        <Link to={`/dashboard/customer/product/${product.id}`}>
                          <h3 className={cn(
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button 
                          variant="outline" 
                          onClick={() => navigate(`/dashboard/customer/product/${product.id}`)}
                          className={cn(
                            "flex-1 transition-all duration-200",
                            isDarkMode 
