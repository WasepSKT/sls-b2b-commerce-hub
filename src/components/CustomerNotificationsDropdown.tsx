...
import { Bell, Check, Package, ShoppingBag, CreditCard, AlertCircle, Settings, Trash2 } from "lucide-react";
...
export const CustomerNotificationsDropdown = ({ className }: { className?: string }) => {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      ...
      message: "Payment for order #ORD-1234 has been confirmed",
      type: "success",
      time: "2 hours ago",
      read: false,
    },
    ...
    },
    {
      ...
      message: "Check out the latest additions to our catalog",
      type: "info",
      time: "2 days ago",
      read: true,
    },
...
export default CustomerNotificationsDropdown; 