...
import { Bell, Check, User, ShoppingCart, CreditCard, AlertCircle, Settings, Trash2 } from "lucide-react";
...
export const AgentNotificationsDropdown = ({ className }: { className?: string }) => {
  const { isDarkMode } = useTheme();
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: 1,
      title: "New Customer Order",
      message: "Customer Retail Store Ltd has placed a new order",
      type: "info",
      time: "10 minutes ago",
      read: false,
    },
    {
      ...
      message: "You have received a commission payment of Rp 500,000",
      type: "success",
      time: "3 hours ago",
      read: false,
    },
    {
      ...
      message: "A new customer has registered under your agency",
      type: "info",
      time: "Yesterday",
      read: true,
    },
    {
      ...
      message: "Prices for 5 products have been updated",
      type: "warning",
      time: "2 days ago",
      read: true,
    },
...
export default AgentNotificationsDropdown; 